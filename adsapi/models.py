...
class Product(models.Model):
    ...
    user_type = models.CharField(max_length=100,default="null")
    ...
    subCategoryType=models.CharField(default="null",max_length=255)
    subCategoryValue=models.CharField(default="null",max_length=255)
    viewsproduct = models.IntegerField(default=0)
    phoneNumber =models.CharField(default="null",null=True,blank=True,max_length=112)
    BuildUpArea =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    Flor =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    ApartMentType =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    Availability =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    FurnishedType =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    Property =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    Parking =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    PowerBackup =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    Gym =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    Garden =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    Pool =models.CharField(default="NoData",null=True,blank=True,max_length=255)
    Lift =models.CharField(default="NoData",null=True,blank=True,max_length=2255)
    PlanCategory = models.CharField(default="null", max_length=255,null=True)
    featured_ads = models.CharField(default="null", max_length=255,null=True)
    ads_limit = models.CharField(default="null", max_length=255,null=True)
    ads_timing = models.CharField(default="null", max_length=255,null=True)
    top_listing = models.CharField(default="null", max_length=255,null=True)
    support = models.CharField(default="null", max_length=255,null=True)
    colorCheck= models.CharField(default="null", max_length=255,null=True)
    sizeCheck= models.CharField(default="null", max_length=255,null=True)
    oldPetsCheck= models.CharField(default="null", max_length=255,null=True)
    start= models.CharField(default="null", max_length=255,null=True)
    end= models.CharField(default="null", max_length=255,null=True)
    school=models.CharField(default="null", max_length=255,null=True)
    college=models.CharField(default="null", max_length=255,null=True)
    brand=models.CharField(default="null", max_length=255,null=True)
    engine=models.CharField(default="null", max_length=255,null=True)
    year=models.CharField(default="null", max_length=255,null=True)
    kmdriven=models.CharField(default="null", max_length=255,null=True)
    setkmDriven=models.CharField(default="null", max_length=255,null=True)
    registrationYear=models.CharField(default="null", max_length=255,null=True)
    setregistrationYear=models.CharField(default="null", max_length=255,null=True)
    extraField=models.CharField(default="null", max_length=232333332,null=True)
    adsType=models.CharField(default="null", max_length=255,null=True)
    plan=models.CharField(default="null", max_length=255,null=True)
    DaysLimit=models.IntegerField(default=0)
    expiry=models.BooleanField()
    deleted=models.BooleanField(default=False)
    uuid=models.CharField(default="null", max_length=255,null=True)
    phoneNumberCollectVisiters=models.CharField(default="null", max_length=255,null=True)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.validity > 0:
            ...
            expiration_date = self.created_date + timezone.timedelta(days=self.validity)
...
class adsmangeme(models.Model):
    ...
    adsUserId=models.ForeignKey(User, related_name='related_secondary_manual_roats',on_delete=models.CASCADE)
    message=models.TextField()
    connectMember=models.CharField(max_length=255,default="srishtisrija@gmail.com")
...
class ImageAdsModels(models.Model):
    ...
    image = models.ImageField(upload_to ='upload/images',null=False,blank=False, default="null")
...
class LastLogin(models.Model):
    ...
    lastloginValue =models.CharField(max_length=255)
...
class Pricing(models.Model):
    ...
    regulars = models.CharField(max_length=255,null=True)
    topAds = models.CharField(max_length=255,null=True)
    featured = models.CharField(max_length=255,null=True)
    ...
    validity= models.CharField(max_length=255,null=True)
...
class BusinessPricing(models.Model):
    ...
    visiblity= models.CharField(max_length=255,null=True)
    NoAds=models.CharField(max_length=255,null=True)
    # added 
...
class WishlistData(models.Model):
    User=models.ForeignKey(User, on_delete=models.CASCADE)
    wishlistData=models.CharField(max_length=255,null=False)

class CurrentDate(models.Model):
    dateFiled=models.CharField(max_length=255)
...
class BusinessProfile(models.Model):
    ...
    aadhar_card = models.FileField(upload_to='', blank=False, null=False, max_length=255)
    pan_card = models.FileField(upload_to='', blank=False, null=False, max_length=255)
