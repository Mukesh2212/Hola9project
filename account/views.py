...
class QrCodeAds(APIView):
  def post(self, request, format=None):
        ...
        Logo_link = '/myproject/hola9DjangoLatest/adsapi/hola9.png'
        ...
        QRimg.save('/myproject/hola9DjangoLatest/adsapi/gfg_QR.png')
        logo1 = Image.open("/myproject/hola9DjangoLatest/adsapi/gfg_QR.png")
        print(logo1)
        file_path = os.path.join("/myproject/hola9DjangoLatest/adsapi/", "gfg_QR.png")
        with open("/myproject/hola9DjangoLatest/adsapi/gfg_QR.png", "rb") as image_file:
...
#             if employee.password == password and employee.name == name:
