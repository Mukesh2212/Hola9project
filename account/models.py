...
class User(AbstractBaseUser):
  ...
  phoneNumber=models.CharField(max_length=255,null=False,default=False)
...
class ReviewSection(models.Model):
    ...
    image = models.ImageField(upload_to ='upload/images',null=True,blank=False,)
...
#     name = models.CharField(max_length=128, blank=False)  # You can adjust the max_length as needed
...
#     report_of_work = models.CharField(max_length=255)
