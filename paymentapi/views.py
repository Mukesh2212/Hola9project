...
def callback(request):
	...
	if status=="Transaction Successful" and s.paymentStatus != "Success":
		...
		json1_file = open('/root/myproject/hola9DjangoLatest/paymentapi/json/pricingPlan.json','r+', encoding="utf-8")
		planJsonOBJ=json.load(json1_file)
		planJsonOBJ1 = open('/root/myproject/hola9DjangoLatest/paymentapi/json/businessPlan.json','r+', encoding="utf-8")
...
class create_payment_token_Class(APIView):
	def post( self,request , format=None):
		...
		planJsonOBJ = open('/root/myproject/hola9DjangoLatest/paymentapi/json/businessPlan.json','r+', encoding="utf-8")
