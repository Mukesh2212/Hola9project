...
def otpGeneration(request):
    ...
    # querystring = {"authorization":"IS0hQCtHZsjNYBXJP3bkDmdOvwu5eqEnAT8ixfaLr79M2z64lGbI2qNadjntC6yYPKF9GQBEODe7X4hR","variables_values":generatedOTP,"route":"otp","numbers":number}
